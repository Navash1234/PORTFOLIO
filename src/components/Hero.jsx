...
import profilePic from "/NavashProfile.jpg";
        ...
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="pb-6 text-5xl font-thin tracking-tight lg:mt-16 lg:text-6xl"
            >
              Navash Ahamed
            </motion.h1>
            <motion.span
        ...
        <div className="w-full lg:w-1/2 lg:p-8">
          <div className="flex justify-center">
            <motion.img
              ...
              className="w-80 h-[350px] lg:w-96 lg:h-[450px] rounded-2xl object-cover shadow-lg border-4 border-violet-500"
            />
          </div>
        </div>
      </div>
